...
// Use 'rufus' in the driver path, so that we don't accidentally latch onto a user driver
  static CHAR16* DriverPath = L"\\EFI\\UEFI_NTFS\\ntfs_x64.efi";
...
// indiscriminately seems to uses "EFI\Boot" or "efi\boot"
  static CHAR16* LoaderPath = L"\\YAMS\\EFI\\BOOT\\grubx64.efi";
// Always good to know the arch we're running
  static CHAR16* Arch = L"x64";
#elif defined(_M_IX86) || defined(__i386__)
  static CHAR16* DriverPath = L"\\EFI\\UEFI_NTFS\\ntfs_ia32.efi";
  static CHAR16* LoaderPath = L"\\YAMS\\EFI\\BOOT\\grubia32.efi";
  static CHAR16* Arch = L"ia32";
#elif defined (_M_ARM64) || defined(__aarch64__)
  static CHAR16* DriverPath = L"\\EFI\\UEFI_NTFS\\ntfs_aa64.efi";
  static CHAR16* LoaderPath = L"\\YAMS\\EFI\\BOOT\\grubaa64.efi";
  static CHAR16* Arch = L"aa64";
#elif defined (_M_ARM) || defined(__arm__)
  static CHAR16* DriverPath = L"\\EFI\\UEFI_NTFS\\ntfs_arm.efi";
  static CHAR16* LoaderPath = L"\\YAMS\\EFI\\BOOT\\grubarm.efi";
